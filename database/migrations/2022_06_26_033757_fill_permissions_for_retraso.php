...
class FillPermissionsForRetraso extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRetraso constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.retraso',
            'admin.retraso.index',
            'admin.retraso.create',
            'admin.retraso.show',
            'admin.retraso.edit',
            'admin.retraso.delete',
            'admin.retraso.bulk-delete',
        ]);
