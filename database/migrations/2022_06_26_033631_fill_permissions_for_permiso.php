...
class FillPermissionsForPermiso extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPermiso constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.permiso',
            'admin.permiso.index',
            'admin.permiso.create',
            'admin.permiso.show',
            'admin.permiso.edit',
            'admin.permiso.delete',
            'admin.permiso.bulk-delete',
        ]);
