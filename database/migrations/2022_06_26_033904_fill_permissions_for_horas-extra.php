...
class FillPermissionsForHorasExtra extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForHorasExtra constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.horas-extra',
            'admin.horas-extra.index',
            'admin.horas-extra.create',
            'admin.horas-extra.show',
            'admin.horas-extra.edit',
            'admin.horas-extra.delete',
            'admin.horas-extra.bulk-delete',
        ]);
