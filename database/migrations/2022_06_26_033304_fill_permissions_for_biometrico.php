...
class FillPermissionsForBiometrico extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForBiometrico constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.biometrico',
            'admin.biometrico.index',
            'admin.biometrico.create',
            'admin.biometrico.show',
            'admin.biometrico.edit',
            'admin.biometrico.delete',
            'admin.biometrico.bulk-delete',
        ]);
