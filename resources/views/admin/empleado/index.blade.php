                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'nic'">{{ trans('admin.empleado.columns.nic') }}</th>
                                        <th is='sortable' :column="'codigo_empleado'">{{ trans('admin.empleado.columns.codigo_empleado') }}</th>
                                        <th is='sortable' :column="'nombres'">{{ trans('admin.empleado.columns.nombres') }}</th>
                                        <th is='sortable' :column="'apellido_paterno'">{{ trans('admin.empleado.columns.apellido_paterno') }}</th>
                                        <th is='sortable' :column="'apellido_materno'">{{ trans('admin.empleado.columns.apellido_materno') }}</th>
                                        <th is='sortable' :column="'telefono'">{{ trans('admin.empleado.columns.telefono') }}</th>
                                        <th is='sortable' :column="'celular'">{{ trans('admin.empleado.columns.celular') }}</th>
                                        <th is='sortable' :column="'email'">{{ trans('admin.empleado.columns.email') }}</th>
                                        <th is='sortable' :column="'profesión'">{{ trans('admin.empleado.columns.profesión') }}</th>
                                        <th is='sortable' :column="'puesto'">{{ trans('admin.empleado.columns.puesto') }}</th>
                                        <th is='sortable' :column="'id_departamento'">{{ trans('admin.empleado.columns.id_departamento') }}</th>
                                        <th is='sortable' :column="'id_turno'">{{ trans('admin.empleado.columns.id_turno') }}</th>
