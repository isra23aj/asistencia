<div class="form-group row align-items-center" :class="{'has-danger': errors.has('fecha'), 'has-success': fields.fecha && fields.fecha.valid }">
    <label for="fecha" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.multa.columns.fecha') }}</label>
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('id_empleado'), 'has-success': fields.id_empleado && fields.id_empleado.valid }">
    <label for="id_empleado" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.multa.columns.id_empleado') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.id_empleado" v-validate="''" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('id_empleado'), 'form-control-success': fields.id_empleado && fields.id_empleado.valid}" id="id_empleado" name="id_empleado" placeholder="{{ trans('admin.multa.columns.id_empleado') }}">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('id_registro'), 'has-success': fields.id_registro && fields.id_registro.valid }">
    <label for="id_registro" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.multa.columns.id_registro') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.id_registro" v-validate="''" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('id_registro'), 'form-control-success': fields.id_registro && fields.id_registro.valid}" id="id_registro" name="id_registro" placeholder="{{ trans('admin.multa.columns.id_registro') }}">
