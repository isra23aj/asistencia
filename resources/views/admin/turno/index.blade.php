                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'codigo_turno'">{{ trans('admin.turno.columns.codigo_turno') }}</th>
                                        <th is='sortable' :column="'nombre_turno'">{{ trans('admin.turno.columns.nombre_turno') }}</th>
                                        <th is='sortable' :column="'descripcion'">{{ trans('admin.turno.columns.descripcion') }}</th>
                                        <th is='sortable' :column="'horas_trabajo'">{{ trans('admin.turno.columns.horas_trabajo') }}</th>
                                        <th is='sortable' :column="'hora_entrada_am'">{{ trans('admin.turno.columns.hora_entrada_am') }}</th>
                                        <th is='sortable' :column="'hora_salida_am'">{{ trans('admin.turno.columns.hora_salida_am') }}</th>
                                        <th is='sortable' :column="'hora_entrada_pm'">{{ trans('admin.turno.columns.hora_entrada_pm') }}</th>
                                        <th is='sortable' :column="'hora_salida_pm'">{{ trans('admin.turno.columns.hora_salida_pm') }}</th>
                                ...
                                <tbody>
                                    ...
                                    <td>@{{ item.id }}</td>
                                        <td>@{{ item.codigo_turno }}</td>
                                        <td>@{{ item.nombre_turno }}</td>
                                        <td>@{{ item.descripcion }}</td>
                                        <td>@{{ item.horas_trabajo }}</td>
                                        <td>@{{ item.hora_entrada_am }}</td>
                                        <td>@{{ item.hora_salida_am }}</td>
                                        <td>@{{ item.hora_entrada_pm }}</td>
                                        <td>@{{ item.hora_salida_pm }}</td>
