                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'hora_entrada_am'">{{ trans('admin.registro.columns.hora_entrada_am') }}</th>
                                        <th is='sortable' :column="'hora_salida_am'">{{ trans('admin.registro.columns.hora_salida_am') }}</th>
                                        <th is='sortable' :column="'hora_entrada_pm'">{{ trans('admin.registro.columns.hora_entrada_pm') }}</th>
                                        <th is='sortable' :column="'hora_salida_pm'">{{ trans('admin.registro.columns.hora_salida_pm') }}</th>
                                        <th is='sortable' :column="'codigo_empleado'">{{ trans('admin.registro.columns.codigo_empleado') }}</th>
                                        <th is='sortable' :column="'id_biometrico'">{{ trans('admin.registro.columns.id_biometrico') }}</th>
                                        <th is='sortable' :column="'id_empleado'">{{ trans('admin.registro.columns.id_empleado') }}</th>
                                ...
                                <tbody>
                                    ...
                                    <td>@{{ item.id }}</td>
                                        ...
                                        <td>@{{ item.hora_entrada_am | time }}</td>
                                        <td>@{{ item.hora_salida_am | time }}</td>
                                        <td>@{{ item.hora_entrada_pm | time }}</td>
                                        <td>@{{ item.hora_salida_pm | time }}</td>
                                        <td>@{{ item.codigo_empleado }}</td>
                                        <td>@{{ item.id_biometrico }}</td>
